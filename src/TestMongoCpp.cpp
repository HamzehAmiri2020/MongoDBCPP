...
//
//	mongocxx::collection collections = conn["testdb"]["testcollection"];
//	document << "hello" << "world";
//
//	collections.insert_one(document.view());
//	mongocxx::cursor cursor1 = collections.find({ });
//
//	for (bsoncxx::document::view_or_value doc : cursor1) {
//		bool ss = doc.is_owning();
